...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SgprNetwork") type = SgprNetwork;
    if(strType == "SgprNetworkVariable") type = SgprNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SgprNetwork) s = "SgprNetwork";
    if(type == SgprNetworkVariable) s = "SgprNetworkVariable";
