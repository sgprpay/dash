...
{
    const char* pszTimestamp = "Two football team of Asisan: Malaysia and Vietnam surprise AFC U23";
    const CScript genesisOutputScript = CScript() << ParseHex("04e1345e4575241ab5ec1d7ccaac9c86a9ab55fd059d6ae68620889177da498db53abcdbf39a827c3e92d048ae6db27267dbb3352be7937e7cb1a8e32672d83357") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 7200; // actual historical value
        consensus.nMasternodePaymentsIncreasePeriod = 720*10; // 17280 - actual historical value
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1516424400; // Feb 5th, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1517788800; // Feb 5th, 2018

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1516424400; // Oct 15th, 2017
         ...
         * a large 32-bit integer with any alignment. asiancup sgprpay.com
         */
        ...
        genesis = CreateGenesisBlock(1516424400, 382898, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
		
        assert(consensus.hashGenesisBlock == uint256S("0x00000b48fb0971cf4291ebe8629d8f0e6e405cf32f0fd81a33c6ac2f846f4ac6"));
        assert(genesis.hashMerkleRoot == uint256S("0x4333124a3e680bbca8fb713b9b0eba48fefad1981c8f39181ceb133cd7eac531"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000b48fb0971cf4291ebe8629d8f0e6e405cf32f0fd81a33c6ac2f846f4ac6"))
			(  2161, uint256S("0x0000008efd4177dc6ebdace0982cb57923af711526c799ffa87bcf27073448dc"))
            ,
            1516541842, // * UNIX timestamp of last checkpoint block
            2162,    // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams() {
        ...
        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1516424400; // September 28th, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1538092800; // September 28th, 2018

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1516424400; // Sep 18th, 2017
        ...
        genesis = CreateGenesisBlock(1516424401, 311415, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
		
        assert(consensus.hashGenesisBlock == uint256S("0x000005568bc715f73451a9ba2ece98416fea64f6c9322fa7adc0805ef62abcbb"));
        assert(genesis.hashMerkleRoot == uint256S("0x4333124a3e680bbca8fb713b9b0eba48fefad1981c8f39181ceb133cd7eac531"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000005568bc715f73451a9ba2ece98416fea64f6c9322fa7adc0805ef62abcbb"))
            ,

            1516424401, // * UNIX timestamp of last checkpoint block
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1516424402, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
		
        assert(consensus.hashGenesisBlock == uint256S("0x6a154fc3e3954a798201b8c5dd9846ded00c4d077c4e1b3e6e227c41c6d4c06e"));
        assert(genesis.hashMerkleRoot == uint256S("0x4333124a3e680bbca8fb713b9b0eba48fefad1981c8f39181ceb133cd7eac531"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x6a154fc3e3954a798201b8c5dd9846ded00c4d077c4e1b3e6e227c41c6d4c06e")),
            1516424402,
            0,
            0
        };
