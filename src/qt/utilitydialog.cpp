    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sgpr Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sgpr Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sgpr-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sgpr in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SGPR, 0.1 SGPR, 1 SGPR and 10 SGPR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sgprpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sgprpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sgpr Core is shutting down...") + "<br /><br />" +
