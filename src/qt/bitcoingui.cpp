...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sgpr"), this);
    aboutAction->setStatusTip(tr("Show information about Sgpr"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sgpr"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Sgpr help message to get a list with possible Sgpr command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sgpr client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Sgpr"); // default title
