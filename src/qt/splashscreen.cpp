    ...
    QWidget(0, f), curAlignment(0)
{
	...
	QString copyrightTextSgpr   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Sgpr developers"));
	...
	pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextSgpr);
