...
Sgpr is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19601.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 19600 for connections and services them.
...
However, in open source software such as Sgpr, where everyone uses
...
pay attention to for reviewers of Sgpr code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sgpr uses tinyformat, which is type safe. Leave them out to avoid confusion
