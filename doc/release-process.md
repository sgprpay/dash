...
### Sgpr maintainers/release engineers, update (commit) version in sources
...
### Build and sign Sgpr for Linux, Windows, and OS X:
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [sgpr-detached-sigs](https://github.com/sgpr/sgprcore-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
