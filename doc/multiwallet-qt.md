...
Only requiring some minor changes is sgpr.cpp.
...
Changes to sgpr.cpp
----------------------
sgpr.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
